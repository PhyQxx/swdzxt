 ...
 */
public class NewExcelSaxReader {
    ...
    public NewExcelSaxReader(MyCallback callback){
     ...
     */
    public NewExcelSaxReader parse(InputStream stream)
     ...
     * @throws ParseException
     */
    public synchronized NewExcelSaxReader parse(InputStream stream, int sheetId)
            throws InvalidFormatException, IOException, ParseException {
        // 每次转换前都清空数据
        datas.clear();
        // 打开表格文件输入流
